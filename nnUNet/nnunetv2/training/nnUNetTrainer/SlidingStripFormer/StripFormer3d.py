...
if __name__ == '__main__':
    ...
    # 根据新的分辨率设计调整window sizes
    # Stage 1: [96, 32, 32] - 使用较大的Z轴窗口
    # Stage 2: [48, 14, 14] - 中等窗口
    # Stage 3: [24, 7, 7] - 小窗口
    # Stage 4: [12, 3, 3] - 使用全局注意力或小窗口
    ...
    # 打印每个阶段的理论序列长度
    # resolutions = [[96, 28, 28], [48, 14, 14], [24, 7, 7], [12, 7, 7]]
    # print("\n各阶段序列长度:")
    # for i, res in enumerate(resolutions):
    #     seq_len = res[0] * res[1] * res[2]
    #     print(f"Stage {i+1}: {res} -> 序列长度: {seq_len:,}")
